# -*- coding: utf-8 -*-
"""
Created on Fri Nov 24 17:09:27 2023
...
R2 = 1.45  #rayon initial de secundus en AU
...
#param 
x1= sol.y[0] #position x de super jupiter 
y1= sol.y[1] #position y de super jupiter 
u1= sol.y[2] #vitesse x de super jupiter 
v1= sol.y[3] #vitesse y de super jupiter 
x2= sol.y[4] #position x de secundus
y2= sol.y[5] #position y de secundus
u2= sol.y[6] #vitesse x de secundus 
v2= sol.y[7] #vitesse y de secundus
...
plt.title('Orbite secundus')
plt.legend()
plt.savefig('orbitesecundus.png')
plt.show() 
...
plt.ylabel('r (AU)')
plt.legend()
plt.savefig('rayonsuperjupiter.png')
plt.show()

#graph de la distamce radial de secundus
r2 = np.sqrt(x2**2 + y2**2)
plt.plot(t, r2, label='secundus')
plt.xlabel('t (annees)')
plt.ylabel('r (AU)')
plt.savefig('rayonsecundus.png')
plt.show()